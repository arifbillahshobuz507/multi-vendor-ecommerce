...
use App\Http\Controllers\login\AdminController as LoginAdminController;
use App\Http\Controllers\UserLogin\AdminController as UserLoginAdminController;
...
Route::group(['prefix' => 'backend'], function () {
    ...
    Route::get('/login/form', [UserLoginAdminController::class, 'loginform'])->name('login.form');
    Route::post('/login-form-post', [UserLoginAdminController::class, 'loginpost'])->name('login.form.post');

    Route::group(['middleware' => 'adminLogin'], function () {
        // admin dashbord || backend dashbord Routes
        Route::get('/dashbord', [AdminController::class, 'backendHomePage'])->name('admin.dashboard');
