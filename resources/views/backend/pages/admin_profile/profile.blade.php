				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex flex-column align-items-center text-center">
							<td>
								<img class="border border-warning rounded-pill" width="110" height="50" src="" alt="">
							</td>
							@foreach($admins as $admin)
							<div class="mt-3">
								<h4>{{$admin->password .$admin->password }}</h4>
								<p class="text-muted font-size-sm">{{$admin->gmail}}</p>
								<a class="btn btn-primary" href="{{route('edit.admin', $admin->id)}}">Edit Profile</a>
							</div>
						</div>
						<hr class="my-4">
