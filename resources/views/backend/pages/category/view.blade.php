      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="feat-single two mt-5">            
            <div class="feat-cont">
            <h4 class="container">Name: {{$categories->name}}</h4>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="feat-img d-table">
            <div class="d-table-cell align-middle text-center">
              <img class="img-fluid animation-jump rounded border border-warning" src="{{url('category/image/' .$categories->image)}}" alt="image">
            </div>
          </div>
        </div>
        <div class="col-md-4">
